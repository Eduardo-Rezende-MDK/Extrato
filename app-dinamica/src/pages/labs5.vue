<template>
  <q-page padding>
    ...
    <base-extrato :data="mock.data" v-model:_setup="mock.setup" :events="{ ...myEvents }">

    <template #custom>
      <component :is="mock.data.custom.componente" v-bind="mock.data.custom.data" @click="newEvt"></component>
    </template>
...
<script>
import { exportFile, QBtn } from 'quasar'
